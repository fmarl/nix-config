  ...
  config = mkIf cfg.enable {
    ...
    home.file.".config/niri/config.kdl".text = ''
      ...
      binds {    
          ...
          Mod+Shift+D hotkey-overlay-title="Start dirvish" { spawn "${pkgs.emacs-pgtk}/bin/emacsclient" "-c" "-n" "-e" "(dirvish-dwim)"; }
          ...
          XF86MonBrightnessUp allow-when-locked=true { spawn "${pkgs.brightnessctl}/bin/brightnesctl" "--class=backlight" "set" "+10%"; }
          XF86MonBrightnessDown allow-when-locked=true { spawn "${pkgs.brightnessctl}/bin/brightnesctl" "--class=backlight" "set" "10%-"; }
      ...
      spawn-sh-at-startup "${pkgs.swaybg}/bin/swaybg -i $HOME/Pictures/Wallpaper/DesertPeak/DesertPeak-1.jpg"
    '';
  };
}
